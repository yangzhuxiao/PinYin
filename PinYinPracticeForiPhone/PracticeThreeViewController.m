...
@interface PracticeThreeViewController ()< UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate >
...
@property (nonatomic, copy) PracticeThreeCollectionViewCell *selectedCell;
...
- (void)setUpCollectionViewAndPageControl
{
    ...
    [_itemCollectionView registerClass:[PracticeThreeCollectionViewCell class] forCellWithReuseIdentifier:@"ItemCell"];
...
- (void)confirmSelection:(id)sender {
    if ([_tempFirstTone isEqualToString:_firstTone]
        ...
        && [_selectedCell.pinyinOneTextField.text isEqualToString:_firstPinyin]
...
{
    PracticeThreeCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ItemCell" forIndexPath: indexPath];
